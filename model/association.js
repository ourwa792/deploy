...
Resources.belongsTo(Lesson, {allowNull: true})
...
VideoLesson.bulkCreate([{
    title: "محيط المستطيل" ,
    link: "https://www.youtube.com/watch?v=Fa6_wV59ASs" ,
    description: "الدرس التامن في الوحدة السادسة لكتاب الطالب المدرسي قسم الهندسة - الفصل الاول" ,
    grade: "الرابع" ,
    quizess:[{"time": 88,
     "asked": false,
     "correct": 3,
     "options": ["شكل خماسي يحوي زوايا و اضلاع", "شكل رباعي فيه ضلعان قائمان", "شكل رباعي فيه كل ضلعان متقابلان متوازيان و متساويان و زوياه قائمة", "مربع اضلاعه متعامدة"],
     "question": "ما هو تعريف المستطيل "},
     
     {"time": 210, "asked": false, "correct": 2,
    "options": ["نجمع زواياه", "نجمع اطوال اضلاعه", "نطرح مساحته من مجموع اطوال اضلاعه", "نجمع الاضلاع ونقسم على 2"],
    "question": "إحدى طرق حساب محيط مستطيل هي؟"}] ,
    thumbnailUrl: "https://res.cloudinary.com/dg0d0jmtz/image/upload/v1722591378/video-thumbnails/%D8%A7%D9%84%D8%B5%D9%81_%D8%A7%D9%84%D8%B1%D8%A7%D8%A8%D8%B9_%D8%A7%D9%84%D9%85%D8%B3%D8%AA%D8%B7%D9%8A%D9%84_bkuyey.png" ,
}, 
{
    title: "طبيعة الاعداد" ,
    link: "https://www.youtube.com/watch?v=DKDB0vxa1Nk&list=PLWqC3JK8M-Su1xRz8LYthGFBiPknMUViF" ,
    description: "الدرس الأول في قسم الجبر بعنوان طبيعة الاعداد للصف التاسع يتضمن مفاهيم تتعلق بمجموعات الاعداد وكيفية تصنيفها" ,
    grade: "التاسع" ,
    quizess:[
        {
          "time": 53,
          ...
          "question": "من الممكن أن يكون مقام العدد العادي مساوي للصفر"
        },
        {
          "time": 140,
          "asked": false,
          ...
          "question": "في المثال السابق العدد <math><mfrac><mn>5</mn><mn>3</mn></mfrac></math>"
        },
        {
          "time": 252,
          "asked": false,
          ...
          "question": "العدد <math><mi>&#x3C0;</mi></math> هو عدد"
        }
      ],
    thumbnailUrl: "https://res.cloudinary.com/dg0d0jmtz/image/upload/v1722598188/video-thumbnails/%D8%A7%D9%84%D8%B5%D9%81_%D8%A7%D9%84%D8%AA%D8%A7%D8%B3%D8%B9_%D8%A7%D9%84%D8%A7%D8%B9%D8%AF%D8%A7%D8%AF_%D8%A7%D9%84%D8%B9%D8%A7%D8%AF%D9%8A%D8%A9_dwxiau.png"
}]
)
.then((result) => {
...
/* (async ()=> {
  const less = await Lesson.findByPk(2)
  less.exercies = `[
